...
└── src
    ...
    │   ├── ListBooks.js # List books from search page and from main page. Impot in Shelf.js and SearchBooks.js
    │   ├── MainPage.js # Show the shelves with the books. Import in App.js
    │   ├── SearchBooks.js # Show an input to search books and the results. Import in App.js
    │   ├── SelectShelf.js # List the shelves of the library, show the actual shelf and you can change the shelf. Import in Book.js.
    │   └── Shelf.js # Show the name of the shelf and the books on him.
    └──
```
